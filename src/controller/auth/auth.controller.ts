...
import logoutUser from '../../service/impl/auth/logout/logout.impl';
import requestAccessToken from '../../service/impl/auth/requestAccessToken/requestAccessToken.impl';
import sendEmail from '../../service/impl/auth/emailService/sendService.impl';
...
router.post('/request-access-token', authenticationToken, requestAccessToken);
router.post('/send-email', authenticationToken, sendEmail);
